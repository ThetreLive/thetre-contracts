...
npx snarkjs zkey export solidityverifier keys/Verifier.zkey contracts/ThetreDAO/Verifier.sol
sed -i -e 's/pragma solidity \^0.6.11/pragma solidity 0.8.24/g' contracts/ThetreDAO/Verifier.sol
